...
Resource.prototype.traverseTo = function (resourceId) {
    return function(resource) {
        ...
        return resource && resource.parent ? arguments.callee(resource.parent) : null;
    }(this.parent);
};
...
Traversal.prototype.buildChain = function(req) {
    ...
    return function (resource) {
        ...
        if(path) {
            ...
            return arguments.callee(resource_n);
        }
        return resource;
    }(root);
};
...
Traversal.prototype.buildResourceUrl = function(resource, pathname) {
    ...
    (function (resource) {
        ...
        if (resource.parent) {
            arguments.callee(resource.parent);
        }
    })(resource);
    return '/' + parts.join('/');
}
        ...
        if (callbacks && callbacks.length) {
            ...
            return function() {
                ...
                (i+1) == callbacks.length
                    ...
                    : callbacks[i](req, res, arguments.callee);
            }();
        }
    }
    return next();
